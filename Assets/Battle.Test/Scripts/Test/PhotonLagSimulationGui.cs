...
namespace Photon.Pun.UtilityScripts
{
    ...
    {
        [SerializeField] private bool _isBattleAutoStart;
        [SerializeField, Min(0)] private int _battleLag;
        ...
        public void OnGUI()
        {
            ...
            else
            {
                if (_isBattleAutoStart)
                {
                    _isBattleAutoStart = false;
                    Peer.IsSimulationEnabled = true;
                    Peer.NetworkSimulationSettings.IncomingLag = _battleLag;
                    Peer.NetworkSimulationSettings.OutgoingLag = _battleLag;
                }
