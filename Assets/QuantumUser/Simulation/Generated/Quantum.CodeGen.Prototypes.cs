...
namespace Quantum.Prototypes {
  ...
  [System.SerializableAttribute()]
  [Quantum.Prototypes.Prototype(typeof(Quantum.BattleCollisionTrigger))]
  public unsafe partial class BattleCollisionTriggerPrototype : ComponentPrototype<Quantum.BattleCollisionTrigger> {
    public Quantum.QEnum32<BattleCollisionTriggerType> CollisionTriggerType;
    partial void MaterializeUser(Frame frame, ref Quantum.BattleCollisionTrigger result, in PrototypeMaterializationContext context);
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
        Quantum.BattleCollisionTrigger component = default;
        Materialize((Frame)f, ref component, in context);
        return f.Set(entity, component) == SetResult.ComponentAdded;
    }
    public void Materialize(Frame frame, ref Quantum.BattleCollisionTrigger result, in PrototypeMaterializationContext context = default) {
        result.CollisionTriggerType = this.CollisionTriggerType;
        MaterializeUser(frame, ref result, in context);
    }
  }
  [System.SerializableAttribute()]
