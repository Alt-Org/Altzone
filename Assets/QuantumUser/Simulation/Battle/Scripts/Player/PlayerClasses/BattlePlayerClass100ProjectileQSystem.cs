...
/// <summary>
/// Contains @cref{Battle.QSimulation.Player,BattlePlayerClass100ProjectileQSystem} [Quantum System](https://doc.photonengine.com/quantum/current/manual/quantum-ecs/systems) which controls desensitizer projectile's movements, creation and reactions to collisions.
/// </summary>
...
namespace Battle.QSimulation.Player
{
    ...
    ///
    /// This system:<br/>
    /// Creates and launches desensitizer projectile when called by <see cref="BattlePlayerClass100"/> and updates its movements.<br/>
