...
/// which is a default none/empty <see cref="Battle.View.Player.BattlePlayerShieldClassNoneViewController">shield class %view controller</see> with no additional view logic.
/// </summary>
...
{
    /// <summary>
    /// <span class="brief-h">None <see cref="Battle.View.Player.BattlePlayerShieldClassBaseViewController">shield class %view controller</see>.</span><br/>
    /// Default none/empty shield view controller with no additional view logic.
    /// </summary>
    ///
