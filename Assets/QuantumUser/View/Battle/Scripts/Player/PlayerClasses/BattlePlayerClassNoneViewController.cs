...
/// <summary>
/// A view controller for the <see cref="BattlePlayerCharacterClass.None"/> class.
/// </summary>
///
...
{
    /// <summary>
    /// View controller for the <see cref="BattlePlayerCharacterClass.None"/> class.<br/>
    /// Implements the base view controller with no additional logic.
    /// </summary>
    public class BattlePlayerClassNoneViewController : BattlePlayerClassBaseViewController
    {
        ...
        /// Always returns <see cref="BattlePlayerCharacterClass.None"/>.
        /// </summary>
