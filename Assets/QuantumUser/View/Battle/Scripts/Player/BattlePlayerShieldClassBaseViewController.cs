...
/// Works together with @cref{Battle.View.Player,BattlePlayerShieldViewController}, which handles the shared player view logic.
/// </summary>
...
namespace Battle.View.Player
{
    ...
    public abstract class BattlePlayerShieldClassBaseViewController : MonoBehaviour
    {
        ...
        /// <summary>Reference to the parent <see cref="BattlePlayerShieldViewController">view controller</see> that manages shared player view logic.</summary>
