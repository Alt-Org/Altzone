...
//     version 1.11.2
//     from Assets/MenuUi/PhotonChat/ChatContoroller.inputactions
//
...
namespace ChatsInputs
{
    ...
    ""controlSchemes"": []
        ...
        ~@ChatInputManager()
        {
            UnityEngine.Debug.Assert(!m_ChatsActions.enabled, "This will cause a leak and performance issues, ChatInputManager.ChatsActions.Disable() has not been called.");
        }
