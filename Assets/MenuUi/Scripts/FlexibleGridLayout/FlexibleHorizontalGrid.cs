...
public class FlexibleHorizontalGrid : LayoutGroup
{
    ...
    public override void CalculateLayoutInputHorizontal()
    {
        ...
        float availableWidth = parentWidth - padding.left - padding.right - ((spacing.x / columns) * (columns - 1));
        float availableHeight = parentHeight - padding.top - padding.bottom - ((spacing.y / rows) * (rows - 1));
