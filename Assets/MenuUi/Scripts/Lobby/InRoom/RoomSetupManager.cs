...
namespace MenuUi.Scripts.Lobby.InRoom
{
    ...
    public class RoomSetupManager : AltMonoBehaviour
    {
        ...
        private void UpdateStatus()
        {
            ...
            SetButtonActive(_toggleBotPlayerP1, _interactablePlayerP1, /*localPlayer.IsMasterClient*/ false);
            SetButtonActive(_toggleBotPlayerP2, _interactablePlayerP2, /*localPlayer.IsMasterClient*/ false);
            SetButtonActive(_toggleBotPlayerP3, _interactablePlayerP3, /*localPlayer.IsMasterClient*/ false);
            SetButtonActive(_toggleBotPlayerP4, _interactablePlayerP4, /*localPlayer.IsMasterClient*/ false);

            SetButtonActive(_toggleBotFill, true, /*localPlayer.IsMasterClient*/ false);
