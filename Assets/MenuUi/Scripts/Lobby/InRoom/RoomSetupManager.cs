...
namespace MenuUI.Scripts.Lobby.InRoom
{
    ...
    public class RoomSetupManager : AltMonoBehaviour
    {
        ...
        private void UpdateStatus()
        {
            ...
            // todo: tee uusiksi slottien valinta photon eventeillä. master clientin tila validi. lähetä viesti master clientille -> master client vaihtaa paikan. coroutine, että vaihtuiko paikka. jos master client disconnectaa lähetetään uudestaan.
