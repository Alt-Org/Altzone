...
namespace MenuUI.Scripts.SoulHome
{
    public class TrayFurniture : MonoBehaviour
    {
        ...
        {
            if (debugValue == 1)
                Furniture = new Furniture(1, "Standard", new Vector2Int(-1, -1), FurnitureSize.OneXOne, 15f);
            else if(debugValue == 2)
                Furniture = new Furniture(2, "ShortWide", new Vector2Int(-1, -1), FurnitureSize.OneXTwo, 15f);
        }
