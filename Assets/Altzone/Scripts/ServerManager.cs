...
public class ServerManager : MonoBehaviour
{
    ...
    public IEnumerator BuyItemToClanFromServer(string itemName, Action<bool> callback)
    {
        string body = @$"{{""itemName"":""{itemName}""}}";
    ...
    public IEnumerator BuyCoinsForClan(int amount, Action<bool> callback)
    {
