...
namespace Altzone.Scripts.Lobby.Wrappers
{
    ...
    public enum LobbyDisconnectCause
    {
    ...
    public enum LobbyServerConnection
    {
    ...
    public enum LobbyClientAppType
    {
    ...
    /// </summary>
    public enum LobbyEncryptionMode
    {
        /// <summary>
    ...
    /// </remarks>
    public class LobbyActorProperties
    {
    ...
    /// "Custom properties" have to use a string-type as key. They can be assigned at will.
    /// </remarks>
    public class LobbyGamePropertyKey
    {
    ...
    public class LobbyParameterCode
    {
    ...
    /// </summary>
    /// <remarks>These constants are used internally.</remarks>
    public class LobbyOperationCode
    {
    ...
    public enum LobbyJoinMode : byte
    {
    ...
    /// </summary>
    public enum LobbyMatchmakingMode : byte
    {
    ...
    /// </summary>
    public enum LobbyReceiverGroup : byte
    {
    ...
    /// </remarks>
    public enum LobbyEventCaching : byte
    {
    ...
    /// </summary>
    [Flags]
    public enum LobbyPropertyTypeFlag : byte
    {
    ...
    public enum LobbyLobbyType : byte
    {
    ...
    /// </summary>
    public enum LobbyAuthModeOption
    {
    ...
    /// </summary>
    public enum LobbyCustomAuthenticationType : byte
    {
