namespace Altzone.Scripts.Model
{
    ...
    public static class ModelLoader
    {
        ...
        public static void LoadAndClearModels()
        {
            ...
            AddCharacterModel("Koulukiusaaja", Defence.Desensitisation, 4, 9, 9, 3);
            AddCharacterModel("Vitsiniekka", Defence.Deflection, 11, 3, 5, 4);
            AddCharacterModel("Pappi", Defence.Introjection, 7, 5, 6, 4);
            AddCharacterModel("Taiteilija", Defence.Projection, 6, 2, 11, 5);
            AddCharacterModel("Hodariläski", Defence.Retroflection, 5, 7, 4, 9);
            AddCharacterModel("Älykkö", Defence.Egotism, 8, 2, 8, 5);
            AddCharacterModel("Tytöt", Defence.Confluence, 7, 6, 4, 6);
