...
All new commands must be added to @ref CommandSetup.User.cs, and @ref Battle.QSimulation.Game.BattleCommand.Type "Type" enum in @ref Battle.QSimulation.Game.BattleCommand "BattleCommand" class at the top of the @ref BattleCommands.cs file.
