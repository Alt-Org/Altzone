...
|                                                                                                                                       |||
| @crefd{Quantum}   | @cref{Quantum,EventBattleViewShowRotateJoystick}       | @copybrief Quantum.EventBattleViewShowRotateJoystick       |
| @crefd{Quantum}   | @cref{Quantum,EventBattleViewHideRotateJoystick}       | @copybrief Quantum.EventBattleViewHideRotateJoystick       |
|                                                                                                                                       |||
